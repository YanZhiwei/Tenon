...
internal sealed class LuaDefaults
{
    ...
    public static readonly string Unlock = "if redis.call('del',KEYS[1]) == 1 then return 1;else return 0;end;";
    ...
    public static readonly string DelayLock = "if redis.call('GET', @key)==@value then redis.call('pexpire', @key, @milliseconds) return 1 end return 0";
}