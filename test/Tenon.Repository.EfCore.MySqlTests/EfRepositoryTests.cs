...
{
    private MySqlTestDbContext _dbContext;
    ...
    public EfRepositoryTests()
    {
        ...
        var serviceProvider = new ServiceCollection()
            ...
            .Configure<MySqlOptions>(configuration.GetSection("MySql"))
            .AddEfCoreMySql<MySqlTestDbContext>(options =>
        {
            options.UseMySql("Server=127.0.0.1;Port=23333;Database=UnitTest;Uid=root;Pwd=123456;",
                serverVersion: ServerVersion.AutoDetect(
                    "Server=127.0.0.1;Port=23333;Database=UnitTest;Uid=root;Pwd=123456;"));
        }).BuildServiceProvider();
        _dbContext = serviceProvider.GetService<MySqlTestDbContext>();
    ...
    public async Task InsertAsyncTest()
    {
        ...
        var blogRepository = new EfRepository<Blog>(_dbContext);
