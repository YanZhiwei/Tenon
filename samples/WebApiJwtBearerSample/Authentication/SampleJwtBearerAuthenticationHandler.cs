...
namespace WebApiJwtBearerSample.Authentication;

public class SampleJwtBearerAuthenticationHandler : JwtBearerAuthenticationHandler
{
    public SampleJwtBearerAuthenticationHandler(IOptionsMonitor<BearerSchemeOptions> options, ILoggerFactory logger,
    ...
    public SampleJwtBearerAuthenticationHandler(IOptionsMonitor<BearerSchemeOptions> options, ILoggerFactory logger,
        UrlEncoder encoder, IOptionsMonitor<JwtOptions> jwtOptions) : base(options, logger, encoder, jwtOptions)
    {
    }
